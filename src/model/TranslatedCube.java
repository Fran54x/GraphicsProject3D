...
public class TranslatedCube extends Figure{
    ...
    public void drawFigure(Boolean orientation) {
...
//
            ...
            //face 2 (Right)
            double[][] face2 = {{super.figurePoints2D[8][0], super.figurePoints2D[8][1]}, {super.figurePoints2D[9][0], super.figurePoints2D[9][1]},
                    {super.figurePoints2D[9][0], super.figurePoints2D[9][1]}, {super.figurePoints2D[1][0], super.figurePoints2D[1][1]},
                    {super.figurePoints2D[1][0], super.figurePoints2D[1][1]}, {super.figurePoints2D[0][0], super.figurePoints2D[0][1]},
                    {super.figurePoints2D[0][0], super.figurePoints2D[0][1]}, {super.figurePoints2D[8][0], super.figurePoints2D[8][1]}};
            for (int i = 0; i < 8; i++) { //accommodate mask position
                face2[i][0] += positionX;
                face2[i][1] += positionY;
...
//
            //face 5 (Back)
            double[][] face5 = {{super.figurePoints2D[11][0], super.figurePoints2D[11][1]}, {super.figurePoints2D[12][0], super.figurePoints2D[12][1]},
                    {super.figurePoints2D[12][0], super.figurePoints2D[12][1]}, {super.figurePoints2D[4][0], super.figurePoints2D[4][1]},
                    {super.figurePoints2D[4][0], super.figurePoints2D[4][1]}, {super.figurePoints2D[3][0], super.figurePoints2D[3][1]},
                    {super.figurePoints2D[3][0], super.figurePoints2D[3][1]}, {super.figurePoints2D[11][0], super.figurePoints2D[11][1]}};
            for (int i = 0; i < 8; i++) { //accommodate mask position
                face5[i][0] += positionX;
                face5[i][1] += positionY;
            }
            view.drawFillPolygon(face5, obscureyellow);
//
            //face 6 (Top)
            double[][] face6 = {{super.figurePoints2D[8][0], super.figurePoints2D[8][1]}, {super.figurePoints2D[9][0], super.figurePoints2D[9][1]},
                    {super.figurePoints2D[9][0], super.figurePoints2D[9][1]}, {super.figurePoints2D[10][0], super.figurePoints2D[10][1]},
