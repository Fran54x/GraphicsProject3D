...
// Bloque 3
        ...
        for (int i = 0; i < 4 ;i++) {
            view.drawFillEllipse((int) figurePoints2D[i][0] + positionX, (int) figurePoints2D[i][1] + positionY, 10, 10, Color.YELLOW);
        }

        for (int i = 14; i < 20 ;i++) {
            view.drawFillEllipse((int) figurePoints2D[i][0] + positionX, (int) figurePoints2D[i][1] + positionY, 10, 10, Color.RED);
        }
        ...
        //view.drawFillPolygon(f1, skyBlue);
        ...
        //view.drawFillPolygon(f2, skyBlue);
        ...
        //view.drawFillPolygon(f3, skyBlue);
